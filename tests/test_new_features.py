...
class TestDynamicKFactor:
    ...
    def test_no_stage_uses_default(self, tmp_db):
        engine = RatingEngine(tmp_db)
        w, l = engine.elo_update("P", "Q", "cricket", K=32, stage="")
        assert w > 1500
...
class TestEnhancedH2H:
    ...
    def test_h2h_recent_win_rate(self, tmp_db):
        for i in range(10):
            ...
            tmp_db.insert_match({
                "sport": "test", "team_a": "X", "team_b": "Y",
                "winner": winner, "date": f"2026-01-{10-i:02d}",
            })
...
class TestFormVelocity:
    ...
    def test_form_velocity_calculation(self):
        ...
        match = {
            ...
            "sport": "cricket", "venue": "Mumbai", "stage": "group",
    ...
    def test_meta_learner_trains(self):
        ...
        for i in range(20):
            matches.append({
                ...
                "venue": venues[i % len(venues)], "stage": "group", "sport": "cricket",
                "elo_a": 1500 + i * 10, "elo_b": 1500 - i * 5,
            })
...
class TestBiasAuditor:
    ...
    def test_stage_breakdown(self):
        preds = [
            ...
            {"team_a": "A", "team_b": "B", "prob_a": 0.7, "predicted_winner": "A",
             "actual_winner": "B", "is_correct": False, "stage": "semi"},
            {"team_a": "C", "team_b": "D", "prob_a": 0.8, "predicted_winner": "C",
             "actual_winner": "C", "is_correct": True, "stage": "group"},
        ]
    ...
    def test_upset_detection(self):
        preds = [
            {"team_a": "Fav", "team_b": "Dog", "prob_a": 0.85,
             "predicted_winner": "Fav", "actual_winner": "Dog",
             "is_correct": False, "stage": "group"},
        ]
        result = BiasAuditor.audit(preds)
